...
Form::Form(std::string newName, const int newGradeToExecute, const int newGradeToSign, bool isSigned = false) : name(newName), gradeToExecute(newGradeToExecute), gradeToSign(newGradeToSign)
{
